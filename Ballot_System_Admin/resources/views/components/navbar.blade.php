    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start rtl:justify-end">
        ...
        <a href="/dashboard" class="flex ms-2 md:me-24">
          <img src="{{ asset('images/logo.jpg') }}" class="h-8 me-3" alt="Buksu Comelec Logo" />
          <span class="self-center text-xl font-bold sm:text-2xl whitespace-nowrap dark:text-white">Buk<span class="text-[#FF9800]">SU</span> Comelec</span>
        </a>
      </div>
