...
use App\Http\Controllers\CandidateNewController;
...
// Route::get('/migrate', [CandidateNewController::class, 'migrate'])->name('migrate'); //!pang migrate og candidates
// Route::get('/hash', [CandidateNewController::class, 'hash'])->name('hash');  //!pang hash

//admin here
Route::post('/login', [adminController::class, 'login'])->name('login.admin')->middleware('guest');
Route::get('/logout', [adminController::class, 'logout'])->name('logout.admin');
// Route::get('/registeradmin', [adminController::class, 'register'])->name('registeradmin');
