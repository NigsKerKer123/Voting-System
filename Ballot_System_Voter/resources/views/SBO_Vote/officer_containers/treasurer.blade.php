...
<div class="p-6 rounded-lg mt-3 text-center justify-center flex flex-col" style="width: 20cm; height: auto; background-color: white;">
    <p class="font-bold text-2xl" style="font-size: 20px;">Treasurer</p>
    ...
    <div class="p-6 rounded-lg items-center flex flex-wrap">
        @foreach($candidateArray as $candidateArrayData)
            @if($candidateArrayData->position_id == "POS77261")
                <div style="width: 150px; height: 150px; margin-left: 50px; margin-top: 3cm; display: flex; flex-direction: column;">
                    ...
                    <div class="flex items-center justify-center" style="align-items: flex-start;">
                        <input class="mr-1" type="radio" name="treasurer" value="{{$candidateArrayData->student_id}}" onchange="displayTreasurer()" style="margin-top: 5px;">
                        <p class="treasurer">{{$candidateArrayData->name}}</p>
                    </div>
...
<!--associate treasurer here-->
<div class="p-6 rounded-lg mt-3 text-center justify-center flex flex-col" style="width: 20cm; height: auto; background-color: white;">
    <p class="font-bold text-2xl" style="font-size: 20px;">Associate Treasurer</p>
    ...
    <div class="p-6 rounded-lg items-center flex flex-wrap">
        @foreach($candidateArray as $candidateArrayData)
            @if($candidateArrayData->position_id == "POS31200")
            <div style="width: 150px; height: 150px; margin-left: 50px; margin-top: 3cm; display: flex; flex-direction: column;">
                <img src="{{asset('images/' . $candidateArrayData->picture_id . '.jpg')}}" alt="person" style="width: 100%; height: 100%;">
                <div class="flex items-center justify-center" style="align-items: flex-start;">
                    <input class="mr-1" type="radio" name="associate_treasurer" value="{{$candidateArrayData->student_id}}" onchange="displayAssociate_treasurer()" style="margin-top: 5px;">
                    <p class="associate_treasurer">{{$candidateArrayData->name}}</p>
                </div>
                <p style="display: none;">{{$candidateArrayData->partylist}}</p>
            </div>
            @endif
